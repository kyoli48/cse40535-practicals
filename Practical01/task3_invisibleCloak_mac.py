...
while(cap.isOpened()):
    ...
    # Yellow namecard: H ~20-25, S higher range to exclude white

    lower_hsv = np.array([18, 80, 150])
    ...
    #
    # res1 extracts background pixels where the mask is white (cloak detected)
    ...
    #
    # res2 extracts current frame pixels where mask is black (non-cloak areas)
    ...
    #
    # Combines both images with equal weight to create the invisibility effect
